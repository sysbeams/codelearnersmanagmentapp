...
public class Assessment : AuditableEntity
{
    ...
    #region Constructor
    private Assessment() { }
    internal Assessment(DateTime scheduledDateTime, string remark, AssessmentStatus assessmentStatus, AssessmentMode assessmentMode, AssessmentType assessmentType, AssessmentResult assessmentResult)
    {
