...
{
    /// <inheritdoc />
    public partial class CLHManagement : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Students_Sponsor_SponsorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseMode = table.Column<int>(type: "int", nullable: false),
                    AssessmentMode = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicantEnrollments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ApplicantEnrollments_Applicants_ApplicantId",
                        column: x => x.ApplicantId,
                        principalTable: "Applicants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicantEnrollments_Courses_CourseId",
                        column: x => x.CourseId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicantEnrollments_ApplicantId",
                table: "ApplicantEnrollments",
                column: "ApplicantId");

            migrationBuilder.CreateIndex(
                name: "IX_ApplicantEnrollments_CourseId",
                table: "ApplicantEnrollments",
                column: "CourseId");
